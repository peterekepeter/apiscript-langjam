...
_lr_action_items = {'$end':([0,1,2,3,4,7,8,45,65,],[-57,0,-1,-57,-57,-2,-3,-16,-4,]),'METHOD':([0,3,4,45,65,],[5,5,5,-16,-4,]),'TABLE':([0,3,4,45,65,],[6,6,6,-16,-4,]),'DOT':([5,13,14,54,90,104,],[10,10,10,73,73,107,]),'UPDIR_SEGMENT':([5,13,14,],[12,12,12,]),'PATH_SEGMENT':([5,10,12,13,14,],[13,13,13,13,13,]),'CAPTURING_SEGMENT':([5,10,12,13,14,],[14,14,14,14,14,]),'NAME':([6,23,27,28,29,30,31,43,64,66,71,73,74,79,80,93,97,100,103,107,109,111,],[15,41,49,50,54,54,54,41,79,41,54,54,90,-14,79,79,104,90,-9,108,110,-15,]),'LAMBDA':([9,11,13,14,17,18,19,20,21,22,],[16,-19,-57,-57,-17,-18,-20,-22,-23,-21,]),'OPEN_BRACES':([15,16,39,47,76,78,],[23,40,40,40,40,40,]),'DOLLAR_SIGN':([16,47,],[27,27,]),'FORMAT':([16,47,],[28,28,]),'EXCLUDE':([16,47,],[29,29,]),'JOIN':([16,47,],[30,30,]),'SELECT':([16,47,],[31,31,]),'STRING':([16,39,40,47,76,78,101,],[32,32,62,32,32,32,62,]),'INTEGER':([16,39,47,76,78,],[33,33,33,33,33,]),'DOUBLE':([16,39,47,76,78,],[34,34,34,34,34,]),'BOOLEAN':([16,39,47,76,78,],[35,35,35,35,35,]),'NULL':([16,39,47,76,78,],[36,36,36,36,36,]),'OPEN_BRACKET':([16,39,47,76,78,],[39,39,39,39,39,]),'CLOSE_BRACES':([23,40,42,43,44,61,63,66,67,68,82,101,103,106,],[-57,-57,65,-57,-6,77,-56,-57,-5,-8,-7,-57,-9,-55,]),'SEMICOLON':([24,25,26,29,32,33,34,35,36,37,38,46,48,49,50,51,52,53,54,55,57,69,70,72,75,77,79,80,83,84,85,93,94,95,96,98,99,102,111,],[45,-57,-27,-57,-44,-45,-46,-47,-48,-49,-50,-24,-26,-28,-29,-30,-57,-34,-38,-31,-32,-57,-33,-36,-51,-54,-14,-57,-25,-57,-37,-13,103,-10,-11,-35,-43,-12,-15,]),'PIPE':([25,26,29,32,33,34,35,36,37,38,49,50,51,52,53,54,55,57,69,70,72,75,77,84,85,98,99,],[47,-27,-57,-44,-45,-46,-47,-48,-49,-50,-28,-29,-30,-57,-34,-38,-31,-32,47,-33,-36,-51,-54,-57,-37,-35,-43,]),'COMMA':([32,33,34,35,36,37,38,52,54,59,75,77,84,85,87,89,90,92,99,],[-44,-45,-46,-47,-48,-49,-50,71,-38,76,-51,-54,71,-37,100,-41,-42,101,-43,]),'CLOSE_BRACKET':([39,58,60,76,91,],[-57,75,-53,-57,-52,]),'COLON':([41,62,],[64,78,]),'OPEN_PAREN':([54,56,81,85,90,],[-38,74,97,-37,-38,]),'FK':([64,79,80,93,111,],[81,-14,81,81,-15,]),'CLOSE_PAREN':([74,86,88,100,105,110,],[-57,99,-40,-57,-39,111,]),'AS':([108,],[109,]),}
...
_lr_productions = [
  ...
  ('db_query_list -> empty','db_query_list',1,'p_db_query_list','parser.py',222),
  ('db_query_item -> db_query','db_query_item',1,'p_db_query_item','parser.py',231),
  ('db_query_item -> NAME','db_query_item',1,'p_db_query_item','parser.py',232),
  ('db_query -> compound_name OPEN_PAREN db_query_list CLOSE_PAREN','db_query',4,'p_db_query','parser.py',244),
  ('raw_value -> STRING','raw_value',1,'p_raw_value','parser.py',253),
  ('raw_value -> INTEGER','raw_value',1,'p_raw_value','parser.py',254),
  ('raw_value -> DOUBLE','raw_value',1,'p_raw_value','parser.py',255),
  ('raw_value -> BOOLEAN','raw_value',1,'p_raw_value','parser.py',256),
  ('raw_value -> NULL','raw_value',1,'p_raw_value','parser.py',257),
  ('raw_value -> list','raw_value',1,'p_raw_value','parser.py',258),
  ('raw_value -> object','raw_value',1,'p_raw_value','parser.py',259),
  ('list -> OPEN_BRACKET list_elements CLOSE_BRACKET','list',3,'p_list','parser.py',265),
  ('list_elements -> raw_value COMMA list_elements','list_elements',3,'p_list_element','parser.py',273),
  ('list_elements -> empty','list_elements',1,'p_list_element','parser.py',274),
  ('object -> OPEN_BRACES object_elements CLOSE_BRACES','object',3,'p_object','parser.py',283),
  ('object_elements -> STRING COLON raw_value COMMA object_elements','object_elements',5,'p_object_elements','parser.py',291),
  ('object_elements -> empty','object_elements',1,'p_object_elements','parser.py',292),
